...
insert into public.category_catalog (id, group_id, group_name, canonical_name) values
  ...
  ('hweng',       'hwdesign',    'Hardware and software engineering',                'Systems integrators'),
  ...
  ('seceng',      'protocols',   'Protocols, proofs, assurance & red-teaming',       'Security Engineer'),
  ...
  ('syseng',      'buildrun',    'Building, testing & running the system',           'Systems Engineer'),
